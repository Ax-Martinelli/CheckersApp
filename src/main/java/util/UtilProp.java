...
public class UtilProp {
	   ...
	   static String _PROP_FILENAME_WIN_LOCAL = "C:\\Users\\itscr\\Desktop\\software engineering\\workspace4830\\checkers\\CheckersApp\\src\\main\\webapp\\config.properties";
	   static String _PROP_FILENAME_OSX_LOCAL = "/YOUR_PATH/webproject/WebContent/config.properties";
	   // * Remote server path
	   static String _PROP_FILENAME_REMOTE = "/var/lib/tomcat9/webapps/CheckersApp/config.properties";
